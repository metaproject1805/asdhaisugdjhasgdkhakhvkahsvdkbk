    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_ref', models.ManyToManyField(blank=True, related_name='_profiles_profile_active_ref_+', to=settings.AUTH_USER_MODEL)),
                ...
                ('pending_ref', models.ManyToManyField(blank=True, related_name='_profiles_profile_pending_ref_+', to=settings.AUTH_USER_MODEL)),
                ('ref_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_ref_by', to=settings.AUTH_USER_MODEL)),
